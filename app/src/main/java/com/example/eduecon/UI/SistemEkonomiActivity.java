...
public class SistemEkonomiActivity extends AppCompatActivity {

    ConstraintLayout expandableView, expandableView1, expandableView2, expandableView3, expandableView4, expandableView5;
    Button arrowBtn, arrowBtn1, arrowBtn2, arrowBtn3, arrowBtn4, arrowBtn5;
    CardView cardView, cardView1, cardView2, cardView3, cardView4, cardView5;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sistem_ekonomi);
