...
public class ProduksiKegiatanEkonomiActivity extends AppCompatActivity {
    ...
    ConstraintLayout expandableView, expandableView1, expandableView2, expandableView3, expandableView4, expandableView5, expandableView6, expandableView7, expandableView8, expandableView9, expandableView10, expandableView11, expandableView12, expandableView13;
    Button arrowBtn, arrowBtn1, arrowBtn2, arrowBtn3, arrowBtn4, arrowBtn5, arrowBtn6, arrowBtn7, arrowBtn8, arrowBtn9, arrowBtn10, arrowBtn11, arrowBtn12, arrowBtn13;
    CardView cardView, cardView1, cardView2, cardView3, cardView4, cardView5, cardView6, cardView7, cardView8, cardView9, cardView10, cardView11, cardView12, cardView13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrowBtn13.setOnClickListener(v -> {
            if (expandableView13.getVisibility()==View.GONE){
                ...
                arrowBtn13.setBackgroundResource(R.drawable.ic_arrowup);
            } else {
                TransitionManager.beginDelayedTransition(cardView13, new AutoTransition());
                expandableView13.setVisibility(View.GONE);
                arrowBtn13.setBackgroundResource(R.drawable.ic_arrowdown);
            }
        });
    }
}