package com.example.eduecon.Constract;
...
public class Constants {
    ...
    public static final String QUIZ7 = "Quiz7";
    public static final String QUIZ8 = "Quiz8";
    public static final String QUIZ9 = "Quiz9";
    public static final String QUIZ10 = "Quiz10";
}
